...
// Fonctions pour gérer les données (append, delete, delete all)
...
const server = http.createServer((req, res) => {
  ...
  if(req.method === 'GET' && (req.url.startsWith('/map') || req.url.startsWith('/'))) {
    let filePath = req.url === '/map' ? path.join(PUBLIC_DIR, 'index.html') : path.join(PUBLIC_DIR, req.url);
